    ...
    describe(`GET ${RouterDefault_1.pathApi}/usuario/perfil/menu`, () => {
        it('Verifica se menu esta na estruta especificada.', done => {
            helpers_1.request(helpers_1.app)
                ...
                helpers_1.expect(res.body.dashboards[0]).to.have.contains.keys(['_id', 'descricao']);
                ...
                helpers_1.expect(res.body.grupo_menus[0]).to.have.keys('titulo', 'menus');
                ...
                helpers_1.expect(res.body.grupo_menus[0].menus[0]).to.have.keys(['_id', 'tipo', 'descricao', 'url', 'icone']);
                done(error);
            });
        });
    });
